...
git clone https://github.com/SPARKTEA/sparkteam1.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf sparkteam1 && rm -rf .telegram-cli && git clone git clone https://github.com/SPARKTEA/sparkteam1.git && cd sparkteam1 && ./launch.sh install && ./launch.sh
~~~~~
